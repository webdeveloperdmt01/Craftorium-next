...
import jewelleryImg from "../images/Jewellery.webp";
import potteryImg from "../images/Pottery.webp";
import textilesImg from "../images/Textiles.webp";
import wallDecorImg from "../images/Wall-Decor.webp";
          ...
          {collections.map((item, index) => (
            ...
            >
              <div className="relative w-full h-[216px] overflow-hidden">
                <Image
                  src={item.image} // public folder path
                  alt={item.title}
