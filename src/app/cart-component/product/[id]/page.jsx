        ...
        <div className="px-6 md:px-16 lg:px-32 pt-14 space-y-10">
            ...
            <div className="flex flex-col items-center">
                <div className="flex flex-col items-center mb-4 mt-16">
                 ...
                 <FeaturedProduct allProducts={products} currentProduct={productData} />
                
                <button className="px-8 py-2 mt-4 mb-16 border rounded text-gray-500/70 hover:bg-slate-50/90 transition">
                    See more
                </button>
            </div>
        </div>
